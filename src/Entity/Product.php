...
class Product
{
    ...
    #[ORM\OneToMany(mappedBy: 'id_product', targetEntity: CommandeDetails::class)]
    ...
    public function addCommandeDetail(CommandeDetails $commandeDetail): self
    {
        if (!$this->commandeDetails->contains($commandeDetail)) {
            ...
            $commandeDetail->setIdProduct($this);
        }
    ...
    public function removeCommandeDetail(CommandeDetails $commandeDetail): self
    {
        if ($this->commandeDetails->removeElement($commandeDetail)) {
            ...
            if ($commandeDetail->getIdProduct() === $this) {
                $commandeDetail->setIdProduct(null);
            }
        }
